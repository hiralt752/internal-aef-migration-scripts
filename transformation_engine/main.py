...
TARGET_FILES = frozenset((
    ...
    "IMAGE_LABELLING_DRAG_DROP.json",
    "FILL_IN_THE_BLANK_DRAG_DROP.json"
))
            ...
            for lesson_entry in top:
                ...
                with os.scandir(
                    ...
                    for file_entry in sub:
                        ...
                        if (
                            file_entry.is_file()
                            and file_entry.name in TARGET_FILES
                        ):

                            qtype = file_entry.name.replace(
                                ".json",
                                ""
                            )
